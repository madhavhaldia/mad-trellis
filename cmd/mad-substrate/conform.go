...
import (
	...
	"github.com/madhavhaldia/mad-substrate/internal/conformance"
)
...
// ~/.mad-substrate — prints the coverage matrix + per-check PASS/FAIL + a final
...
func conformCmd() *cobra.Command {
	return &cobra.Command{
		...
		Long: "conform boots a REAL governed scenario through the PUBLIC daemon contract + CLI ONLY and " +
			...
			"acceptance gate. The harness is hermetic: its own daemon on a scratch runtime, never ~/.mad-substrate.",
